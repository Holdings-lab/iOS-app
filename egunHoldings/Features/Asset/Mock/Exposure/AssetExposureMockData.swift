...
struct AssetExposureMockData {
    static let dashboard = AssetExposureDashboard(
        summaryItems: [
            PolicyExposureSummaryItem(id: 1, title: "반도체 투자정책", exposurePercent: 28, summary: "SOXX와 빅테크 간접 노출이 겹쳐 있어요.", color: .brand),
            PolicyExposureSummaryItem(id: 2, title: "금리 인하 경로", exposurePercent: 61, summary: "예금·대출·은행 ETF가 같이 노출돼 있어요.", color: .brand),
            PolicyExposureSummaryItem(id: 3, title: "친환경 에너지", exposurePercent: 17, summary: "ICLN이 직접 노출 구간이에요.", color: .success),
            PolicyExposureSummaryItem(id: 4, title: "달러 강세", exposurePercent: 24, summary: "달러 현금과 미국 ETF 평가액에 영향을 줘요.", color: .warning)
        ],
        holdingRows: [
            HoldingPolicyExposureRow(
                ...
                exposures: [
                    PolicyExposureChip(id: 1, title: "반도체 보조금", exposureText: "높음", color: .brand),
                    PolicyExposureChip(id: 2, title: "달러 강세", exposureText: "중간", color: .warning)
                ],
            ...
            HoldingPolicyExposureRow(
                ...
                exposures: [
                    PolicyExposureChip(id: 3, title: "친환경 정책", exposureText: "높음", color: .success),
                    PolicyExposureChip(id: 4, title: "정책 지연", exposureText: "중간", color: .up)
                ],
            ...
            HoldingPolicyExposureRow(
                ...
                exposures: [
                    PolicyExposureChip(id: 5, title: "금리 경로", exposureText: "높음", color: .brand),
                    PolicyExposureChip(id: 6, title: "가계대출 규제", exposureText: "중간", color: .warning)
                ],
            ...
            HoldingPolicyExposureRow(
                ...
                exposures: [
                    PolicyExposureChip(id: 9, title: "금리 경로", exposureText: "높음", color: .up),
                    PolicyExposureChip(id: 10, title: "가계대출 규제", exposureText: "중간", color: .warning)
                ],
        ...
        scenarioVariants: [
            RebalanceScenarioVariant(id: 1, title: "기준", suggestedChange: "SOXX +2%", note: "정책 예정대로, 환율 보합", color: .brand),
            RebalanceScenarioVariant(id: 2, title: "비관", suggestedChange: "현금 +5%", note: "PCE와 금리 톤 모두 보수적", color: .up),
            RebalanceScenarioVariant(id: 3, title: "지연", suggestedChange: "ICLN -2%", note: "전력망 예산 집행 지연", color: .warning),
            RebalanceScenarioVariant(id: 4, title: "낙관", suggestedChange: "SOXX +4%", note: "보조금 총액 상향 + 집행 속도 개선", color: .success)
        ],
        executionPlan: [
