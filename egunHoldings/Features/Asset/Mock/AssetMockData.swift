...
struct AssetMockData {
    static let dashboard = AssetDashboard(
        ...
        defenseMetrics: [
            AssetDefenseMetric(id: 1, title: "현금 방어력", value: "18%", color: .electricBlue),
            AssetDefenseMetric(id: 2, title: "달러 방어력", value: "25%", color: .policyAmber),
            AssetDefenseMetric(id: 3, title: "정책 집중도", value: "68%", color: .policyPurple),
            AssetDefenseMetric(id: 4, title: "과매매 위험", value: "낮음", color: .emerald)
        ],
        holdingRows: [
            AssetHoldingRow(
                id: 1,
                ...
                amount: "₩3,190,000",
                tags: [
                    AssetPolicyTag(id: 1, title: "반도체 높음", color: .policyPurple),
                    AssetPolicyTag(id: 2, title: "미중갈등 중간", color: .policyCoral)
                ]
            ),
            AssetHoldingRow(
                id: 2,
                ...
                amount: "₩2,010,000",
                tags: [
                    AssetPolicyTag(id: 3, title: "금리 높음", color: .electricBlue),
                    AssetPolicyTag(id: 4, title: "대출규제 중간", color: .policyAmber)
                ]
            ),
            AssetHoldingRow(
                id: 3,
                ...
                amount: "₩1,680,000",
                tags: [
                    AssetPolicyTag(id: 5, title: "에너지 높음", color: .emerald),
                    AssetPolicyTag(id: 6, title: "정책지연 중간", color: .policyAmber)
                ]
            ),
            AssetHoldingRow(
                id: 4,
                ...
                amount: "₩1,600,000",
                tags: [
                    AssetPolicyTag(id: 7, title: "채권 높음", color: .electricBlue),
                    AssetPolicyTag(id: 8, title: "금리역방향 중간", color: .policyCoral)
                ]
            ),
            AssetHoldingRow(
                id: 5,
                ...
                amount: "₩1,250,000",
                tags: [
                    AssetPolicyTag(id: 9, title: "달러 중간", color: .policyAmber),
                    AssetPolicyTag(id: 10, title: "방어자산 높음", color: .emerald)
                ]
            )
        ],
        hiddenBets: [
